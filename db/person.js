...
const getPersonalAccount = (id) => {
    ...
    return read('persons', id).then((result) => {
        ...
        data.personalDetail.totalCashSales = _.sumBy(data.CashSales, 'totalAmount')
        data.personalDetail.totalCashPurchase = _.sumBy(data.CashPurchase, 'totalAmount')
        data.personalDetail.totalCreditSales = _.sumBy(data.CreditSales, 'totalAmount')
        data.personalDetail.totalCreditPurchase = _.sumBy(data.CreditPurchase, 'totalAmount')
